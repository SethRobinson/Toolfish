...
#define TTS_BALLOON 0x40  //hack, shouldn't need this if we installed the latest
//platform SDK.  (Seth)
...
public:
    ...
    //Seth - Added this so I can just pass filenames
    DWORD SetBitmaps(TCHAR *p_bitmap_in, COLORREF crTransColorIn, TCHAR *p_bitmap_out, COLORREF crTransColorOut);
