...
bool GetWebFile(const char * p_st_server, const char *p_st_file, CTextParse *p_parse, CWebHeader *p_header, const bool b_authenticate = false, const WCHAR *p_wst_logon = NULL, const WCHAR *p_wst_pass = NULL);
